...
export function WarehouseSelector({ warehouses, value, onChange, disabled, placeholder = "Select Warehouse" }: WarehouseSelectorProps) {
    ...
    return (
      <View style={[styles.selector, styles.disabledSelector]}>
        ...
        <Text style={[styles.valueText, { color: '#6b7280' }]}>
          {selectedWarehouse ? (selectedWarehouse.warehouse_name || selectedWarehouse.name) : "No Warehouse Selected"}
        </Text>
      </View>
    );
  }
  ...
  return (
    <View>
      ...
      >
        <Package style={styles.icon} size={18} color="#9ca3af" />
        <Text style={[styles.valueText, !selectedWarehouse && styles.placeholderText]}>
          {selectedWarehouse ? (selectedWarehouse.warehouse_name || selectedWarehouse.name) : placeholder}
        </Text>
          ...
          <View style={styles.modalContent}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  <Text style={styles.optionName}>{item.warehouse_name || item.name}</Text>
