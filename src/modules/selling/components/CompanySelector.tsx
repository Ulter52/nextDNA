...
import { Building2, ChevronDown, Search, X } from 'lucide-react-native';
...
export function CompanySelector({ companies, value, onChange, disabled }: CompanySelectorProps) {
  ...
  if (disabled) {
    return (
      <View style={[styles.selector, styles.disabledSelector]}>
        <Building2 style={styles.icon} size={18} color="#9ca3af" />
        <Text style={[styles.valueText, { color: '#6b7280' }]}>
          {selectedCompany ? (selectedCompany.company_name || selectedCompany.name) : "No Company Selected"}
        </Text>
      </View>
    );
  }
  ...
  return (
    <View>
      ...
      >
        <Building2 style={styles.icon} size={18} color="#9ca3af" />
        <Text style={[styles.valueText, !selectedCompany && styles.placeholderText]}>
          ...
          <View style={styles.modalContent}>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                ...
                >
                  <Text style={styles.optionName}>{item.company_name || item.name}</Text>
