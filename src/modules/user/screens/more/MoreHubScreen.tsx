...
export function MoreHubScreen({ onLogout }: MoreHubScreenProps) {
  ...
  const handleNavigate = (route: string) => {
    ...
    if (normalizedRoute === 'financial reports' || normalizedRoute === 'analytics') {
       navigation.navigate('FinancialReports');
    } else if (normalizedRoute === 'settings' || normalizedRoute === 'profile') {
              ...
              <View style={styles.itemGrid}>
                {workspaces.map((ws) => {
                  ...
                  return (
                    <TouchableOpacity
                      key={ws.name}
                      onPress={() => handleNavigate(ws.title || ws.name)}
